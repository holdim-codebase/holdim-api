...
### **1. Submitting an ARC (Aave Request for Comments)**

**Time:** open-ended

**Criteria:** Short and concise title of the ARC; a short and concise description of the proposal; the rationale for the ARC, e.g. why?; the title of the forum post must include 'ARC:' with the short title of the ARC. E.g. ARC: Activation of Aave Protocol Governance V2 Governance; a community poll that community members can use to vote.
...
**Criteria:** All questions and comments should be replied to and taken into consideration, to further improve the ARC

**3. Snapshot vote**

## Governance process - on-chain
### **1. Writing an AIP**

**Time:** open-ended

**Criteria:** The AIP should include all the relevant information as well as links to the forum discussion and snapshot vote.

### **2. Preparing the AIP for on-chain governance**

Time: open-ended

Criteria: The reviewed AIP is merged into the AIP repository and passes the CI pipeline (currently performed by the Aave Genesis Team); The reviewed AIP is parsed and uploaded to IPFS. We recommend using the AIP uploader tool. The returned IPFS hash is needed for the next step; The payload is reviewed and sufficiently tested.

### **3. Submitting the AIP for on-chain governance**

**3.1. Short executor** - Minor changes to the protocol: parameter change, asset listing

Proposition Threshold: 0.5% AAVE 80k

Delay: 1 day

Voting Duration: 3 day

Vote quorum: 2% AAVE 320k

Vote Differential: 0.5% AAVE 80k

Grace Period: 5 days

**3.2. Long time lock** - Change to the core code base of the protocol such as governance

Proposition Threshold: 2% AAVE 320k

Delay: 7 day

Voting Duration: 10 day

Vote quorum: 20% AAVE 3.2m

Vote Differential: 15% AAVE 2.4m

Grace Period: 5 days`,
    tokenOverview: `# AAVE

## Tokens that give you governance power:

**AAVE:** Governance token of Aave Protocol

**aAAVE:** Tokens supplied as collateral to Aave money market

**stkAAVE:** AAVE tokens staked in the Safety Modul

**AAVE in stkBPT:** Balancer pool token staked in Safety Module

**Matic AAVE:** AAVE token on Polygon (Matic)

**amAAVE:** AAVE tokens on Polygon supplied as collateral to Aave money market

**avaxAAVE:** AAVE tokens on Avalanche Network

**avAAVE:** AAVE tokens on Avalanche Network supplied as collateral to Aave money market


## Safety Model - stkAAVE
...
**1. Start a discussion on the Forum**

Time: open-ended

Criteria: Should be followed a spesific Proposal Template

**2. Vote on the proceeding to the voting stage**

Time: 5 days

Criteria: Poll with in favor or against this proposal should be started on the forum. To proceed to the voting should have a majority votes in favor.

**3. Snapshot vote**

Time: 3+ days

Criteria: Anyone holding more than 100k GEL can create the proposal themselves. Ask a Gelato Core Team member to give you the means to create the proposal or to do it on your behalf.

**4. Implementation**`,
    tokenOverview: `# GEL
## Staking of GEL Token
...
Sushi's products are configured in a way that allows the entire platform to maintain decentralized governance of $SUSHI token holders, while continuing to innovate on the collective foundations by design.

## Governance process

1. The SushiSwap community governs the project through forum discussion and voting on proposals.
2. Only proposals that are posted on the SushiSwap Snapshot voting system by the CORE team can be considered binding if they pass with a quorum.
...
Criteria: There should be a general non-biased question to the community about a potential change

**2. Draft Proposal**

Time: Open-Ended

Criteria: To create a draft proposal, start by copying the template for an executable proposal, social proposal, or constitutional amendment. Then, create a Draft Pull Request for it. Start a new post in the DAO-wide -> Draft Proposals category with a link to the PR for discussion.

**3. Active Proposal**

Time: 7 days

Criteria: The creator of the proposal should have 100k ENS delegated to their address in order to submit a proposal. Proposals are stored in the “proposals” mapping of the Governor smart contract. All proposals are subject to a 7-day voting period.

**4. Voting on Executable Proposals**

Time: 7 days

Criteria: Users can vote for or against single proposals once they have voting rights delegated to their address. Votes can be cast while a proposal is in the “Active” state. If the majority of votes (and a 1% quorum of ENS`,
    tokenOverview: `# ENS
## Governs

ENS holders can decide on a variety of topics, including changes to registration or extension costs, funding for public goods, and integration with the legacy DNS system`,
    tokens: [{
...
### **1. Temperature Check — Discourse/Snapshot - off-chain**

**Time:** 3 days

**Criteria:** Ask a general, non-biased question on forum about a potential change; create a snapshot voting: majority vote with a 25k UNI yes-vote threshold wins

### **2. Consensus Check — Discourse/Snapshot - off-chain**

**Time:** 5 days

**Criteria:** Create a new Snapshot poll, incorporate feedback from Temperature check, create a new topic on the forum, 50k UNI yes-vote quorum is required to pass

### **3. Governance Proposal — Governance Portal - on-chain**

**Time:** 7 days voting period

**Criteria:** at least 10 million UNI is delegated to your address; all proposed code should be audited by a professional auditor; at least 40 mil UNI should be "FOR" implementation of the proposal `,
    tokenOverview: `# UNI

## Delegation - voting power unlock

To be able to vote on the governance proposals, UNI token holder should unlock them first. It can be done via this interface - [Uniswap voting dashboard](https://app.uniswap.org/#/vote). To unlock UNI tokens, you need to delegate to yourself or to another person.

If you want to dive deeper into the on-chain part of the voting [check this Beginners Guige to voting](https://docs.uniswap.org/protocol/concepts/governance/guide-to-voting)
...
The 1inch Network DAO is a decentralized organization that is responsible for governing the 1inch Network. The DAO can make decisions about things like how to spend money from the Treasury, or whether to deploy a new protocol on the 1inch Network.
...
**Criteria:** Should consist of a simple summary, abstract, motivation, specification, rationale, considerations

### **3. 1IP Temperature check**

**Time:** 5 days

**Criteria:** Poll in favor or against this proposal should be started on the forum. To proceed to the voting proposal should pass the temperature check

### **4. Snapshot vote**

**Time:** 7 days

**Criteria:** The creator of the proposal should have 25,000 st1INCH or 125,000 v1INCH to start a snapshot voting. The snapshot proposal should have two options in favor and against. To succeed the proposal should have a majority of the votes and pass the minimum quorum of 10 million weighted votes.
...
**v1INCH**: Vested tokens. Each v1INCH has 1/5th (20%) of the Voting Weight compared to st1INCH.

## Delegation
Token holder can delegate their voting power to other community members.
This can be done on the Snapshot page of 1inch Network.

If token holder votes on the proposal, they override the voting power of the person to whom tokens were delegated.
...
4. Factory governance in Liquidity protocol. Parameters shared by all pools: the default swap fee, the default price impact fee, the default decay period, the referral reward, and the Treasury accrual rate.`,
    tokens: [{
...
**Criteria:** There is no formal requirement for the idea to pass to Phase 2 (become a proposal), but the motion must garner notable community support.

### **2. Specification**

**Time:** 5 days

**Criteria:** A clear majority of votes in favour will be required for the proposal to pass onto Phase 3.
...
1. Change DAO parameters within its permissions
2. Execute actions on its behalf
3. Allocate the Active Users Fund (ex. for Liquidity Mining Programs, Bounty Programs and other)
4. Make changes to the Opium Protocol codebase.

Contributors can stake their tokens into different subunits of the DAO to represent a specific role/function in the community or take specific risk.
...
The committees in Lido governance are: LNOSG, LEGO, reWARDS, and RCC.

LNOSG committee manages the node operator registry. The purpose of LNOSG is to reduce operational burden on Lido DAO members. RCC manages the remuneration and other payout processes. It executes, tracks and reports on payroll and other contributor-related operating expenses.

The LEGO committee controls the full life-cycle of the referral program. The purpose of LEGO is to grow the greater liquid staking ecosystem through fast and unimpeded grants to developers.

The reWARDS committee is tasked with incentive management for Lido liquid staking assets. It manages incentive distribution for Liquidity Provider (LP) rewards to Lido liquid staking asset liquidity pools, money markets and other integrations. The purpose of the reWARDS committee is to encourage software developers of wallets and other DeFi protocols to promote our staking protocol among their users.

The RCC committee is dedicated to reduce operational burden on Lido DAO members. RCC manages the remuneration and other payout processes. It executes, tracks and reports on payroll and other contributor-related operating expenses.
...
**Criteria:** Community feedback

### **2. Snapshot voting**

**Time:** 7 days (don't end on weekends, end at least 24h before the next Aragon vote for on-chain execution)

**Criteria:** Minimum quorum of 5% of the total token supply
...
**1. Forum post**
- All major discussions must start as a PTIP
...
- Once submitted, the PTIP should be open for discussion for at least 5 days

**2. PoolTogether Snapshot**
- Snapshot is a voting system that allows token holders to vote gaslessly
- The PoolTogether Snapshot allows all POOL and PPOOL (POOL Prize Pool) token holders to vote gaslessly
- If the Snapshot vote passes with at least 100k votes, then it’s a strong signal that an on-chain proposal would pass
...
The steps in the Balancer governance process are: discussion, proposal, vote, and enactment.
Discussions happen on the Balancer Governance Forum. Anyone can post a thread on the forum to start a discussion.

## Governance process

**1. Request for Comment**

Start a new conversation on the with the [RFC] tag. The message should contain the following sections:
- Background
- Core Proposal(s)
- Dependencies
- Risk assessment
...
Share your updated proposal in the same topic thread as your RFC.
C
hange the tag from [RFC] to [Proposal].

Collect final feedback and get advice for changes.

Wait for at least 7 days and make sure you have a general consensus among the others before moving to Snapshot.

**4. Snapshot**

Now that we have a proposal, we can move into a vote. If you are unable to post your Proposal to Snapshot, ask for help in the Discord #governance channel.
...
The BAL token governs the Balancer Protocol. BAL holders can vote on proposals relevant to the protocol, such as Governable Protocol Fees and the distribution of BAL tokens.

Protocol swap fees are a percentage of swap fees collected by pools. These go to the DAO Treasury to be used or held as the DAO sees fit.`,
    tokens: [{
