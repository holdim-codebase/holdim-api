...
export const paginatedResult = async <T extends Record<string, any>>(repository: T, whereQuery: Record<string, any>, orderBy: Record<string, any>, first?: number, after?: string): Promise<Record<string, any>> => {
